...
3. Download and install the [Adobe Analytics JDBC Driver from CData](https://www.cdata.com/drivers/adobeanalytics/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
